...
def default_codex_bin() -> str:
    if os.name == "nt":
        candidates = [
            ...
            os.path.expandvars(
                r"%LOCALAPPDATA%\Packages\OpenAI.Codex_2p2nqsd0c76g0\LocalCache\Local\OpenAI\Codex\bin\codex.exe"
            ),
            os.path.expandvars(r"%USERPROFILE%\.codex\.sandbox-bin\codex.exe"),
